...
const NewsDetailsStandard: React.FC = () => {
  return (
              ...
              <div className="post-info">
                <div className="author-block info-item my-2">
                  ...
                  <div className="author-content">
                    ...
                    <Link href="#" className="link--uppercase-wide fs-12">Betty Stevens</Link>
                  </div>
                </div>
          ...
          <div className="row">
            <div className="col-lg-8 col-md-12 col-sm-12 col-xs-12">
              <article className="hentry post post-standard has-post-thumbnail post-standard-details">
                <p className="fs-20">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo.</p>
                <div className="wp-caption alignnone my-3 my-sm-5">
                  <img src="/img/post13.jpg" alt="post" />
                  <div className="wp-caption-text">Lorem ipsum dolor sit amet, sint occaecat cupidatat non proident consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore. Photo by @brookecagle <Link href="#">Unsplash</Link></div>
                </div>
                <div className="row">
                    ...
                    <div className="crumina-sticky-sidebar">
                      <div className="sidebar__inner">
                        <ul className="socials socials--round socials--blog">
                          ...
                          <li><Link className="bg-telegram" href="#"><i className="puzzle-icon fab fa-telegram-plane"></i></Link></li>
                          <li><Link className="bg-linkedin" href="#"><i className="puzzle-icon fab fa-linkedin-in"></i></Link></li>
                          <li><Link className="bg-email" href="#"><i className="puzzle-icon far fa-at"></i></Link></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-10 col-md-10 col-sm-10 col-xs-10 col-10">
                    ...
                    <blockquote>
                      <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat velit esse cillum dolore.</p>
                      <h6>Angelina Johnson <span>Graphic Designer</span></h6>
                    </blockquote>
                    <h3>H3. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris</h3>
                    <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                    <div className="wp-caption alignnone my-3 my-sm-5">
                      <img src="/img/post14.jpg" alt="post" />
                      <div className="wp-caption-text">Consectetur adipiscing elit, sed do eiusmod tempor. Photo by @brookecagle <Link href="#">Unsplash</Link></div>
                    </div>
                    ...
                    <ol>
                      ...
                      <li><Link href="#">Veniam, quis nostrud exercitation ullamco.</Link></li>
                      <li><Link href="#">Ut enim ad minim veniam, quis nostrud.</Link></li>
                      <li><Link href="#">Duis aute irure dolor in reprehenderit.</Link></li>
                      <li><Link href="#">Excepteur sint occaecat cupidatat non proident.</Link></li>
                      <li><Link href="#">Sunt in culpa qui officia.</Link></li>
                    </ol>
                    <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                    <h5>H5. Quis nostrud exercitation ullamco laboris nisi ut aliquip:</h5>
                    <ul>
                      <li><Link href="#">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod.</Link></li>
                      <li><Link href="#">Veniam, quis nostrud exercitation ullamco laboris nisi.</Link></li>
                      <li><Link href="#">Ut enim ad minim veniam, quis nostrud.</Link></li>
                      <li><Link href="#">Duis aute irure dolor in reprehenderit in voluptate velit esse.</Link></li>
                      <li><Link href="#">Excepteur sint occaecat cupidatat non proident.</Link></li>
                      <li><Link href="#">Sunt in culpa qui officia deserunt mollit anim id est laborum.</Link></li>
                    </ul>
              ...
              <div className="d-flex justify-content-between align-items-center flex-wrap mt60">
                <Link href="/news/news-details-gallery" className="crumina-button button--dark button--xl button--bordered button--uppercase-wide button--with-icon button--icon-left my-2" style={{width: '45%'}}><i className="puzzle-icon fal fa-long-arrow-left"></i>Previous Post</Link>
                <Link href="/news/news-details-video" className="crumina-button button--dark button--xl button--bordered button--uppercase-wide button--with-icon button--icon-right my-2" style={{width: '45%'}}>Next Post<i className="puzzle-icon fal fa-long-arrow-right"></i></Link>
              </div>

              {/* Comments Section */}
              <div className="comments medium-padding80">
                ...
                {/* Comments list (static for now, can be mapped from data) */}
